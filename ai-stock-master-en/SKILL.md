...
description: Professional AI analysis powered by 3 investment expert models, deeply integrated with OpenClaw AI Agent | https://github.com/hengruiyun/ai-stock-master-openclaw
version: 1.0.0
trigger:
  - "Market Analysis"
  - "Market Sentiment"
...
4. **Master Stock Diagnosis**: Get a final verdict from 3 investment master models (Buffett, Lynch, etc.) `get_stock_analysis('Ticker')`.
...
- **Natural Reporting**: Translate raw "JSON" data into "Professional Analyst Reports." Never mention "API" or "requests."
- **Ticker Support**: Automatically trigger `get_stock_analysis()` when any 6-digit CN code or US Ticker (AAPL/TSLA) is mentioned with analysis intent.
